                ...
                
{
	...
	$query = " SELECT TBL.id, TBL.fk_user_id, TBL.fk_booking_id, TBL.date_time, TBL.pay_type, TBL.paid, TBL.transaction_id, TBL.request, TBL.fk_bank_account_id, TBL.status, TBL.is_deleted" ;
	$query .= "  FROM $table "; 
	$where = " WHERE 1 = 1 ";
	 $where .= " AND ( ";
	...
	$where .=  "  OR  TBL.request LIKE '%".$filter_data['general_search']."%'";
