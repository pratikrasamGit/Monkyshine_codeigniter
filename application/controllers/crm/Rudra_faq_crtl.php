...
class Rudra_faq_crtl extends CI_Controller
{
    ...
    /***********
	//Rudra_faq_crtl ROUTES
        $crud_master = $crm . "Rudra_faq_crtl/";
        $route['rudra_faq'] = $crud_master . 'index';
        $route['rudra_faq/index'] = $crud_master . 'index';
        $route['rudra_faq/list'] = $crud_master . 'list';
        $route['rudra_faq/post_actions/(:any)'] = $crud_master.'post_actions/$1';
     **************/
    ...
    public function list()
    {
        ...
        $orderArray = array('id', 'question','question_dk', 'answer', 'answer_dk', 'status', 'is_deleted',);
        ...
        if (!empty($rows)) {
            $res_json = array();
            foreach ($rows as $row) {
                $actions_base_url = 'rudra_faq/post_actions';
                $actions_query_string = "?id= $row->id.'&target_table='.$row->id";
                $form_data_url = 'rudra_faq/post_actions';
                $action_url = 'rudra_faq/post_actions';
    ...
    public function post_actions($param1)
    {
        ...
        if ($action == "get_data") {
            ...
            $html = $this->load->view("crm/forms/_ajax_rudra_faq_form", $data, TRUE);
            ...
            if (!empty($_POST)) {
                ...
                $updateArray =
                    array(
                        ...
                        'question_dk' => $this->input->post('question_dk', true),
                        'answer' => $this->input->post('answer', true),
                        'answer_dk' => $this->input->post('answer_dk', true),
        ...
        if ($action == "export_data") {
            ...
            $filename = strtolower('rudra_faq') . '_' . date('d-m-Y') . ".csv";
