...
class Rudra_help_apis extends CI_Controller
{
    ...
    /***********************Page Route
     ...
     //rudra_help API Routes
	$t_name = 'auto_scripts/Rudra_help_apis/';    
	$route[$api_ver.'help/(:any)'] = $t_name.'rudra_rudra_help/$1';
    ...
    public function rudra_rudra_help($param1)
    {
        $call_type = $param1;
        $res = array();
        if ($call_type == 'put') {
