            ...
            <div class="card-body">
                <div class="col-sm-3 float-right">
                    <div class="form-group">
                        ...
                        echo form_dropdown($data = '',  $options,  $selected = array(),  $extra = 'class="form-control"'); */ ?>
                    </div>
                </div>
            </div>
        </div>
...
<!--- FORM Modal Ends ---->
<div class="modal fade dynamic-modal" id="form_modal_rudra_user">
...
<script type="text/javascript">
    ...
    $('#ddlAgencyFilter, select[name="user_type"]').change(function() {
        ...
        usrTable = $('.user_post').DataTable({
            ...
            "ajax": {
                ...
                "data": {
                    ...
                    user_type: "1"
                    // user_type: function() {
                    //     return $('select[name="user_type"]').val()
                    // },
                }
            },
            "columns": [{
